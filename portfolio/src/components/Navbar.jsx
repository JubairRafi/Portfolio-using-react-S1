...
<div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
    ...
    {/* mobile menu */}
    <ul className={!nav
        ?'hidden': 'absolute w-full top-0 left-0 h-screen bg-[#0a192f] flex flex-col justify-center items-center' }>
        ...
        <ul>
            <li
                ...
                <a className='flex justify-between items-center w-full text-gray-300'
                    href="https://www.linkedin.com/in/md-jobair-rafi-1b59b4172/" target="_blank">
                    Linkedin
                    <FaLinkedin size={30} />
                </a>
            </li>
            <li
                ...
                <a className='flex justify-between items-center w-full text-gray-300'
                    href="https://github.com/JubairRafi" target="_blank">
                    Github
                    <FaGithub size={30} />
                </a>
            </li>
            <li
                ...
                <a className='flex justify-between items-center w-full text-gray-300'
                    href="mailto:jubairrafi96960@gmail.com">
                    Email
